...
public interface UserService extends IService<User> {
    ...
    LoginUserVO userLoginByPhone(UserLoginByPhoneRequest userLoginByPhoneRequest, HttpServletRequest request);

    /**
     * 签到
     * @param request
     */
    void sign(HttpServletRequest request);

    List<Integer> getSign(HttpServletRequest request);
}
