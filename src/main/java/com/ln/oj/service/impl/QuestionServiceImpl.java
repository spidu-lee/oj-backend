...
import com.ln.oj.mapper.QuestionMapper;
import com.ln.oj.mapper.QuestionSubmitMapper;
import com.ln.oj.model.dto.question.QuestionQueryRequest;
...
* @createDate 2023-08-09 16:51:16
*/
@Service
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public QuestionVO getQuestionVO(Question question, HttpServletRequest request) {
        ...
        if (count == 0) {
            questionVO.setAnswer("无提交记录，无法查看答案");
        }
        // 1. 关联查询用户信息
